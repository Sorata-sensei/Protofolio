...
@section('content')
    <div class="container mt-4">
        <div class="card p-4 shadow-sm">
            ...
            <form action="{{ route('admin.finance.addFund') }}" method="POST" class="row g-3">
                @csrf
                <div class="col-12 col-md-6">
                    <label for="amount" class="form-label">Add Fund (Rupiah)</label>
                ...
                <div class="col-12 mt-1">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3" placeholder="e.g. Salary from May"></textarea>
                </div>
        ...
        <div class="modal fade" id="editFundModal" tabindex="-1" aria-labelledby="editFundModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="editFundForm" method="POST" action="{{ route('admin.finance.editFund') }}">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editFundModalLabel">Edit Fund</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">x</button>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" name="fund_id" id="editFundId" />
                            <div class="mb-3">
                                <label for="editAmount" class="form-label">Add Fund (Rupiah)</label>
